...
export default function HomeDashboard() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-background min-h-0 overflow-hidden">
      ...
      <div className="flex-shrink-0 bg-background/95 backdrop-blur-md border-t border-border px-4 pt-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] flex flex-col">
        <Link href="/practice">
